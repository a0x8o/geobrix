    ...
    override def eval(input: InternalRow): IterableOnce[InternalRow] = {
        ...
        if (geomRaw == null || gridRaw == null || resRaw == null || kRaw == null) {
            ...
            GridErrorHandler.safeEval[IterableOnce[InternalRow]](Iterator.empty) {
                ...
                sys.geometryKLoop(geomDecoded, res, kVal, modeStr)
...
/** Companion: SQL name gbx_custom_geomkloopexplode, 4- or 5-arg builder. */
object Custom_GeometryKLoopExplode extends WithExpressionInfo {
    ...
    override def builder(): FunctionBuilder = (c: Seq[Expression]) => c.length match {
        case 4 => new Custom_GeometryKLoopExplode(c(0), c(1), c(2), c(3), Literal(GeomDilation.DEFAULT_MODE))
        case 5 => new Custom_GeometryKLoopExplode(c(0), c(1), c(2), c(3), c(4))
        case n => throw new IllegalArgumentException(
            s"gbx_custom_geomkloopexplode requires 4 or 5 arguments; got $n")
    }
