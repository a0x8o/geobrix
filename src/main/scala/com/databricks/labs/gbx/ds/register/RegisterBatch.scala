...
class RegisterBatch(schema: StructType, options: Map[String, String]) extends Scan with Batch {
    ...
    /** Overrides Batch.planInputPartitions: runs registration (options "functions" = gridx.bng | gridx.quadbin | gridx.custom | gridx.h3 | vectorx.jts.legacy | rasterx | pmtiles | all); returns empty partitions. */
    override def planInputPartitions(): Array[InputPartition] = {
        ...
        registerWhat match {
            ...
            case "gridx.h3"       => gridx.h3.functions.register(SparkSession.active)
            ...
            case "all"            =>
                ...
                gridx.h3.functions.register(SparkSession.active)
