...
object RST_Quadbin_RasterToGridMin extends WithExpressionInfo {
    ...
    override def builder(): FunctionBuilder = (c: Seq[Expression]) => c.length match {
        case 2 => new RST_Quadbin_RasterToGridMin(c(0), c(1), Literal("complete"), Literal("centroid"))
        case 3 => new RST_Quadbin_RasterToGridMin(c(0), c(1), c(2), Literal("centroid"))
        case 4 => new RST_Quadbin_RasterToGridMin(c(0), c(1), c(2), c(3))
