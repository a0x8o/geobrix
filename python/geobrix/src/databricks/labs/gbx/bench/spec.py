...
REGISTRY: Dict[str, FnSpec] = {
    ...
    "rst_nbr": FnSpec(
        "rst_nbr", "gbx_rst_nbr", "band-math", _BOTH,
    ...
    "rst_to_webmercator": FnSpec(
        "rst_to_webmercator", "gbx_rst_to_webmercator", "warp", _BOTH,
        {"resampling": "bilinear"},
        core_fn=lambda ds, a: warp.reproject_to_srid(ds, 3857, resampling=a["resampling"]),
