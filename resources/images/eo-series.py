    ...
    1: {
        ...
        "stages": [
            ...
            Stage(title="Planetary Computer",
                  subtitle="Query sentinel-2-l2a items intersecting each H3 cell",
                  glyph=g_stac_cloud,
                  chip_text="pystac_client"),
        ...
        "footer_chips": ["shapefile_ogr", "h3_tessellateaswkb", "h3_boundaryasgeojson",
                         "pystac_client", "Delta time-travel"],
    },
    2: {
        ...
        "stages": [
            ...
            Stage(title="Bands of interest",
                  ...
                  chip_text="download_band"),
            Stage(title="Self-healing retry",
                  subtitle="1 KB threshold detects throttled auth-error payloads; Delta MERGE patches them",
        ...
        "footer_chips": ["pandas_udf", "download_band", "update_assets",
                         "download_missing_assets", "Delta MERGE"],
    },
    3: {
        ...
        "stages": [
            Stage(title="Sentinel-2 scene",
                  subtitle="Per-band GeoTIFFs from the Volume, joined with the gdal reader",
                  glyph=g_raster_scene,
                  chip_text="gdal reader"),
            ...
            Stage(title="Per-cell timeseries",
                  ...
                  chip_text="rasterio_lambda"),
        ],
        "footer_chips": ["gdal", "rst_fromcontent", "rst_h3_tessellate",
                         "rst_summary", "rst_initnodata", "h3_kring", "rst_merge_agg"],
    },
    4: {
        ...
        "stages": [
            ...
            Stage(title="GeoTIFF write-back",
                  subtitle="gdal writer materializes stacked tiles to /Volumes/.../alaska/out/stacked-tif",
                  glyph=lambda cx, cy, c, t: g_delta_table(cx, cy, c, t, label="stacked-tif"),
                  chip_text="gdal writer"),
        ...
        "footer_chips": ["rst_frombands", "gdal writer", "rst_clip",
