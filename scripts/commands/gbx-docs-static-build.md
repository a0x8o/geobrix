...
bash scripts/commands/gbx-docs-static-build.sh --output ./docs-build   # or any path; zip name uses version from docs/package.json

# Build only (no zip)
bash scripts/commands/gbx-docs-static-build.sh --skip-zip

# Build and log output
bash scripts/commands/gbx-docs-static-build.sh --log docs-static-build.log
```
