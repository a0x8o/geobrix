...
USAGE:
    bash scripts/commands/gbx-docker-clear-pycache.sh [OPTIONS]
...
EXAMPLES:
    # Basic usage
    bash scripts/commands/gbx-docker-clear-pycache.sh

    # With detailed output
    bash scripts/commands/gbx-docker-clear-pycache.sh --verbose

    # With logging
    bash scripts/commands/gbx-docker-clear-pycache.sh --log cache-clear.log
