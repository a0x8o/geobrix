...
- [Helios notebooks](../notebooks/helios) — use Overture Maps building footprints (`gbx.sample.overture` / `OvertureClient`) as the vector layer in a San Francisco tiling series (NB01).
