...
`gtiff_gbx` is `raster_gbx` with the GeoTIFF driver preset. See the [Lightweight GeoTIFF Reader](./geotiff) for the named-reader page.
...
[Lightweight Raster Writer](../writers/raster).
