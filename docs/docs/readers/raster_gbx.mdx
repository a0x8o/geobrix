...
# Lightweight Raster Reader (`raster_gbx`)
...
`gtiff_gbx` is `raster_gbx` with the GeoTIFF driver preset. See the [Lightweight GeoTIFF Reader](./gtiff_gbx) for the named-reader page.
