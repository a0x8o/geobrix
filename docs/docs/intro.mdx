...
<div style={{
  ...
  <div style={{
    ...
    <img src={GeoBrixLogo} alt="GeoBrix" style={{maxWidth: '100%', maxHeight: '96px', objectFit: 'contain'}} />
  </div>
  {[
    {n: '154', label: 'Functions', accent: '#2e7d32'},
    {n: '107', label: 'RasterX', accent: '#1565c0'},
    {n: '40', label: 'GridX', accent: '#1565c0'},
    {n: '6', label: 'VectorX', accent: '#1565c0'},
    {n: '1', label: 'PMTiles', accent: '#1565c0'},
  ].map((s) => (
