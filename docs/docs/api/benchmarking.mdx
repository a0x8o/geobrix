...
> **`rst_h3_tessellate` benchmarks are pending** a covering/centroid `mode` redesign — light and heavy
> currently diverge on border-cell assignment (~2.4%) and numbers will be added once the redesign lands.
...
> TIN / elevation surface-modeling benchmarks (`gbx_st_triangulate`, `gbx_st_interpolateelevation*`)
