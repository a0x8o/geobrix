...
Cluster spark-path results (DBR 17.3 LTS; median wall-clock of one full distributed iteration over
*N* rows; same corpus both tiers): **pending cluster run** — numbers will be filled in here once the
quadbin cluster benchmark has been run.

| Function | Rows/iter | Heavy (s) | Light (s) | Light speedup |
|---|---|---|---|---|
| `gbx_quadbin_pointascell` | 1,000 | _pending_ | _pending_ | _pending_ |
| `gbx_quadbin_polyfill` | 1,000 | _pending_ | _pending_ | _pending_ |
| `gbx_quadbin_tessellate` | 1,000 | _pending_ | _pending_ | _pending_ |
| `gbx_quadbin_cellunion_agg` | 1,000 | _pending_ | _pending_ | _pending_ |
