...
### BNG (`bng_eastnorthasbng`, `bng_polyfill`, `bng_tessellate`, `bng_kring`, `bng_cellunion_agg`) — benchmarks pending

The British National Grid functions are also available in both tiers — light (pygx, a pure-Python
...
> **Cluster spark-path BNG timings are pending** and will be published here once collected. Parity is
> already test-enforced across the tiers.
