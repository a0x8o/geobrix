...
The two tiers are continuously benchmarked for both speed and output consistency. See **[Benchmarking](./benchmarking)** for the latest per-function heavy-vs-light results and how to run the benchmark on a cluster or locally.
