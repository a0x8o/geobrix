...
**Function Count**: organized into the following categories (see [rasterx/functions.scala](https://github.com/databrickslabs/geobrix/blob/main/src/main/scala/com/databricks/labs/gbx/rasterx/functions.scala)):
...
Per-pixel transformations and band-level extraction. See [Pixel ops + extraction](../packages/rasterx#pixel-ops--extraction) in the RasterX overview for the workflow context.
