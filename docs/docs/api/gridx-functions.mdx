...
**Signature:** `h3_geomkring(cover, core, holes_cover, holes_core, k, [mode])`
...
**Signature:** `h3_geomkloop(cover, core, holes_cover, holes_core, k, [mode])`
...
**Signature:** `h3_geomkringexplode(cover, core, holes_cover, holes_core, k, [mode])`
...
**Signature:** `h3_geomkloopexplode(cover, core, holes_cover, holes_core, k, [mode])`
