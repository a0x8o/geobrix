...
| SQL name | Python name |
|---|---|
| `gbx_rst_separatebands` | `rst_separatebands` |
| `gbx_rst_retile` | `rst_retile` |
| `gbx_rst_tooverlappingtiles` | `rst_tooverlappingtiles` |
| `gbx_rst_maketiles` | `rst_maketiles` |
| `gbx_rst_h3_tessellate` | `rst_h3_tessellate` |
| `gbx_rst_tilexyz` | `rst_tilexyz` |
| `gbx_rst_xyzpyramid` | `rst_xyzpyramid` |
