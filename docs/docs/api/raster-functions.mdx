...
See [interpolation & fill](./grid-raster-tessellation#interpolation-and-fill) for how combining composes with tessellation and how to choose among the sample/resample/fill family.
