...
4. **Embed** in [MapLibre GL JS](https://maplibre.org/) via the pmtiles protocol — see the [PMTiles package page](../packages/pmtiles#serving-from-object-storage) for a worked HTML snippet.
...
- [PMTiles Package Documentation](../packages/pmtiles) — Concepts, schema contract, and serving notes.
