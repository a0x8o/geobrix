...
- **GeoBrix VizX**: [`plot_pmtiles`, `plot_cog`, `pmtiles_info`](../api/vizx-pmtiles#pmtiles-viewers) — inline PMTiles / COG rendering without a tile server.
