...
:::tip View on GitHub
**[notebooks/examples/xview](https://github.com/databrickslabs/geobrix/tree/master/notebooks/examples/xview)** — download `Clipping - xView.ipynb` and import it into your Databricks workspace to run.
:::
