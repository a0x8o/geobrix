...
- **[GridX](https://databrickslabs.github.io/geobrix/docs/api/gridx-functions)** — BNG, Quadbin, and custom grids (pairs with native H3 for global hex). **Quadbin in both tiers** — lightweight `pygx` and heavyweight Scala; **BNG** and **custom grids** heavyweight (lightweight planned).
